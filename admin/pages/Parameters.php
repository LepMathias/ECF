...
<div class="container-fluid">
    <div class="row navbarParam justify-content-around">
        ...
        <button class="col btn btn-param" id="carte-btn">Carte et Menus<i
                    class="bi bi-caret-down-fill"></i></button>
        <button class="col btn btn-param" id="hour-btn">Heures d'ouverture<i
                    class="bi bi-caret-down-fill"></i></button>
        <button class="col btn btn-param" id="reservation-btn">Réservations<i
                    class="bi bi-caret-down-fill"></i></button>
    </div>
</div>
<div id="gallery-menu" class="container-fluid gallery-menu">
    <div class="row ">
        <div class="col-md-3"
            <form name="gallery-form" method="post" action="#">
                <label class="form-label text-center" for="picture">Choisissez une photo à ajouter</label>
                <input class="form-control" type="file" id="picture" name="picture" accept="image/png, imgae/jpeg">

                <label class="form-label" for="pictureName">Nom de la photo</label>
                <input class="form-control" type="text" id="pictureName" name="pictureName">

                <label class="form-label" for="pictureCaption">Nom de la photo</label>
                <input class="form-control" type="text" id="pictureCaption" name="pictureCaption">
